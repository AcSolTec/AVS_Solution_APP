        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                IConfigurationRoot configuration = new ConfigurationBuilder()
                              ...
                              .Build();
                optionsBuilder.UseSqlServer(configuration.GetConnectionString("conAvsDb"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TbAccountsValidate>(entity =>
            {
                entity.HasKey(e => e.IdAccountVal)
                    .HasName("PK__tb_Accou__5D440E4D8A313546");
            ...
            modelBuilder.Entity<TbCuTravShipDet>(entity =>
            {
                ...
                entity.Property(e => e.FirstNameShip)
                    .HasMaxLength(100)
                    .IsUnicode(false);

                entity.Property(e => e.SurnameShip)
                    .HasMaxLength(100)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.ZipCodeShip)
                    .HasMaxLength(100)
                    .IsUnicode(false);
            });
